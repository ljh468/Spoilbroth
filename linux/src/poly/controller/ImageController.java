...
public class ImageController {
	...
	final private String USERFILE_UPLOAD_SAVE_PATH = "/userimg"; // C:\\upload 폴더에 저장 /upload
	...
	public void getImage(HttpServletRequest request, HttpSession session, HttpServletResponse response,
		...
		String realFile = nvl(pMap.get("SAVE_FILE_PATH") + "/"); // 파일이 저장된 경로 : /studyimg/0000/00/00/
