...
<body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
	...
	<div id="colorlib-page">
		...
		<div class="sidebar-heading"
			style="text-align: center; position: fixed; top: 0; width: 100%; height: 190px; background-color: #fff; z-index: 5; padding-top: 20px; font-weight: 500; color: black;">
			<div class="hh" style="font-size: 23px; height: 32px;">
				<span>S</span><span>T</span><span>U</span><span>D</span><span>Y</span><span>&nbsp;</span><span>P</span><span>L</span><span>A</span><span>C</span><span>E</span>
			</div>
			...
			<ul class="tagcloud"
				...
				<a href="/study/contest2.do?contest_area=기획아이디어"
