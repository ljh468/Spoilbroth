					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="emp-profile" style="">
								<label style="font-size: 30px; font-family: 'Do Hyeon', sans-serif; font-family: 'Nanum Pen Script', cursive;">얼굴 등록하기 </label>
								<hr style="margin-top: 0px; margin-bottom: 8px;" />
								<div class="row" style="font-size: 11px; margin: 0px;">
									<!-- 얼굴 등록하기 -->
									<div class="d-flex card p-3" style="width: 100%;height: 300px; margin-bottom: 10px;">
									</div>
									<button class="btn btn-sm btn-primary w-100">등록 시작하기</button>
									<button class="btn btn-sm btn-primary w-100">등록 시작하기</button>
									<!-- 끝 -->
								</div>
							</div>
