...
//				
		...
		String url = "http://13.125.99.115:8000";
		String api = "/facelearningAPI";
	...
	@ResponseBody
	public int faceanalysis(HttpServletRequest request, HttpSession session, @RequestBody Map<String, Object> param) throws Exception {
